...
export default function Date() {
  ...
  return (
    <div  ref={sectionRef} className="max-w-md h-screen mx-auto bg-[url('/bg.png')]
        ...
        {/* Card utama */}
        <div className='w-[90%]  relative bg-secondary rounded-3xl py-5 flex justify-center items-center bellefair text-darkAccent'
             data-aos="zoom-in">

               <div className='w-[90%] mx-auto h-[550px] rounded-3xl border border-primary2' data-aos="fade-up">

                <h1 className='text-center mt-7 w-[96%]' data-aos="fade-up">
                ...
                <h1 className='great tex text-2xl text-center mt-3' data-aos="fade-up">Om Santhi, Santhi, Santhi Om</h1>

                <h2 className='text-center mt-2' data-aos="fade-up">Kami yang berbahagia</h2>
